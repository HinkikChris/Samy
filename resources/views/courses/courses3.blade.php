...
<!-- section -->
<section class="section overlay" data-background="{{ asset('images/courses/IMG-20231026-WA0003.jpg') }}">
    <div class="col-md-auto mb-4">
          <!-- success story -->
          <section class="section bg-cover" data-background="{{ asset('images/courses/IMG-20231026-WA0003.jpg') }}">
              <div class="container">
                  <div class="row">
                      <div class="col-lg-6 col-sm-4 position-relative success-video">
                          <a class="play-btn venobox" href="https://youtu.be/3nYLTiY5skU?feature=shared" data-vbtype="video">
    ...
    <div class="container">
          ...
          <div class="row">
              <div class="col-12 mb-4">
                  ...
                  <p>Bienvenidos al curso completo de HTML5, donde te sumergirás en el mundo del desarrollo web. A lo largo de este curso, aprenderás desde los conceptos básicos hasta las características avanzadas de HTML5.</p>
              </div>
              <div class="col-12 mb-4">
              ...
              <div class="col-12 mb-4">
                  ...
                  <ul class="list-styled">
                      <li>Introducción a HTML5: Comprenderán los fundamentos de HTML5, incluyendo su estructura, elementos, etiquetas y la evolución de HTML a lo largo del tiempo.</li>
                      <li>Creación de Páginas Web: Aprenderán a crear páginas web desde cero utilizando HTML5, incluyendo la estructura básica de un documento HTML.</li>
                      <li>Formato y Estilo: Explorarán cómo dar formato y estilo a las páginas web utilizando CSS (Cascading Style Sheets) para controlar la apariencia de los elementos.</li>
                      <li>Multimedia: Descubrirán cómo incorporar imágenes, audio y video en las páginas web, así como la importancia de la accesibilidad web.</li>
                      <li>Formularios y Elementos Interactivos: Aprenderán a crear formularios interactivos, elementos de entrada, botones y otros componentes interactivos.</li>
                      <li>JavaScript Básico: Introducción a los conceptos básicos de JavaScript para añadir interactividad a las páginas web.</li>
                      <li>Optimización y Rendimiento: Conocerán estrategias para optimizar el rendimiento de las páginas web y la carga rápida en diferentes dispositivos.</li>
                      <li>Responsive Design: Aprenderán cómo diseñar páginas web que se adapten a diferentes tamaños de pantalla y dispositivos (diseño web responsive).</li>
                  </ul>
              </div>
              <div class="col-12 mb-5">
                  ...
                  <ul class="list-styled">
                      ...
                      <li>Certificación: Al completar con éxito el curso, los estudiantes recibirán una certificación que atestiguará su capacidad para crear sitios web utilizando HTML5 y CSS3.</li>
                  </ul>
              </div>
              <!-- teacher -->
              <div class="col-12">
