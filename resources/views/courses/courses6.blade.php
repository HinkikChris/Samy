...
<!-- section -->
<section class="section overlay" data-background="{{ asset('images/courses/IMG-20231026-WA0004.jpg') }}">
    <div class="col-md-auto mb-4">
          <!-- success story -->
          <section class="section bg-cover" data-background="{{ asset('images/courses/IMG-20231026-WA0004.jpg') }}">
              <div class="container">
                  <div class="row">
                      <div class="col-lg-6 col-sm-4 position-relative success-video">
                          <a class="play-btn venobox" href="https://youtu.be/z95mZVUcJ-E?feature=shared" data-vbtype="video">
    ...
    <div class="container">
          ...
          <div class="row">
              <div class="col-12 mb-4">
                  ...
                  <p> Comenzaremos desde los conceptos más básicos, como variables y bucles, y avanzaremos hacia temas más avanzados, incluyendo manipulación del DOM, AJAX y la creación de aplicaciones web interactivas.</p>
              </div>
              <div class="col-12 mb-4">
              ...
              <div class="col-12 mb-4">
                  ...
                  <ul class="list-styled">
                      <li>Introducción a JavaScript: Comprenderán los fundamentos de JavaScript, incluyendo su sintaxis, tipos de datos y estructuras de control.</li>
                      <li>Variables y Operadores: Aprenderán a declarar variables, utilizar operadores aritméticos y de asignación, y manipular datos.</li>
                      <li>Funciones: Explorarán cómo crear y llamar funciones en JavaScript, así como la importancia de los argumentos y el retorno de valores.</li>
                      <li>Estructuras de Control: Aprenderán a utilizar condicionales (if, else) y bucles (for, while) para controlar el flujo de su programa.</li>
                      <li>Manipulación del DOM: Comprenderán cómo acceder y manipular elementos HTML a través del Document Object Model (DOM).</li>
                      <li>Eventos y Event Listeners: Aprenderán a responder a eventos del usuario, como clics y teclas presionadas, utilizando event listeners.</li>
                      <li>Programación Orientada a Objetos (POO): Introducción a conceptos de POO en JavaScript, como objetos, clases y herencia.</li>
                      <li>Manejo de Errores: Aprenderán a gestionar errores y excepciones en JavaScript.</li>
                  </ul>
              </div>
              <div class="col-12 mb-5">
                  ...
                  <ul class="list-styled">
                      ...
                      <li>Certificación: Al completar con éxito el curso, los estudiantes recibirán una certificación que atestiguará su capacidad para programar en JavaScript a nivel junior.</li>
                  </ul>
              </div>
              <!-- teacher -->
              <div class="col-12">
                  ...
                  <div class="d-flex justify-content-between align-items-center flex-wrap">
                      <div class="media mb-2 mb-sm-0">
                          <img class="mr-4 img-fluid" src="{{ asset('images/teachers/dalto.jpg') }}" alt="Teacher">
                          <div class="media-body">
                              <h4 class="mt-0">Lucas Dalto.</h4>
                              Programador Senior.
                          </div>
                      </div>
