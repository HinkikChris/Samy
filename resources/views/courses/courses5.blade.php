...
<head>
  ...
  <!-- Basic Page Needs
	================================================== -->
  <meta charset="utf-8">
  <title>Cursos - Matemáticas</title>
...
<!-- section -->
<section class="section overlay" data-background="{{ asset('images/courses/IMG-20231026-WA0005.jpg') }}">
    <div class="col-md-auto mb-4">
          <!-- success story -->
          <section class="section bg-cover" data-background="{{ asset('images/courses/IMG-20231026-WA0005.jpg') }}">
              <div class="container">
                  <div class="row">
                      <div class="col-lg-6 col-sm-4 position-relative success-video">
                          <a class="play-btn venobox" href="https://youtu.be/6NgEgPD82Zo?feature=shared" data-vbtype="video">
    ...
    <div class="container">
          ...
          <div class="row align-items-center mb-5">
              ...
              <div class="col-xl-3 text-sm-right text-left order-sm-2 order-3 order-xl-3 col-sm-6 mb-4 mb-xl-0">
                  <a href="course-single.html" class="btn btn-primary">Suscribirse</a>
              </div>
              <!-- border -->
          ...
          <div class="row">
              <div class="col-12 mb-4">
                  ...
                  <p>Este curso de aritmética es perfecto para principiantes que desean dominar los conceptos esenciales de las matemáticas. Desde sumas y restas básicas hasta multiplicaciones y divisiones, te guiaremos a través de los fundamentos de la aritmética.</p>
              </div>
              <div class="col-12 mb-4">
                      ...
                      <div class="row">
                          <div class="col-md-6">
                              <ul class="list-styled">
                                  <li>No se requieren conocimientos previos para este curso. Está diseñado para estudiantes de todos los niveles, desde principiantes.</li>
                              </ul>
                          </div>
                      </div>
                  </div>
              ...
              <div class="col-12 mb-4">
                  ...
                  <ul class="list-styled">
                    <li>Números y Operaciones Básicas: Comprenderán los números naturales, enteros, fraccionarios y decimales, así como las operaciones básicas de suma, resta, multiplicación y división.</li>
                    <li>Propiedades de las Operaciones: Explorarán las propiedades de las operación aritméticas, como la conmutativa, asociativa y distributiva, y cómo aplicarlas.</li>
                    <li>Fracciones y Decimales: Aprenderán a trabajar con fracciones y decimales, incluyendo la suma, resta, multiplicación y división de estos números.</li>
                    <li>Porcentaje y Proporciones: Comprenderán el concepto de porcentaje y cómo aplicarlo en situaciones cotidianas, así como trabajar con proporciones y razones.</li>
                    <li>Números Enteros y Teoría de Números: Explorarán los números enteros, los números primos, los múltiplos y los divisores, así como el máximo común divisor y el mínimo común múltiplo.</li>
                    <li>Álgebra Básica: Introducción a conceptos algebraicos, como ecuaciones lineales y resolución de problemas algebraicos simples.</li>
                  </ul>
              </div>
              <div class="col-12 mb-5">
                  ...
                  <ul class="list-styled">
                      ...
                      <li>Certificación: Al completar con éxito el curso, los estudiantes recibirán una certificación que atestiguará su capacidad para comprender y aplicar conceptos aritméticos desde cero.</li>
                  </ul>
              </div>
              <!-- teacher -->
              <div class="col-12">
                  ...
                  <div class="d-flex justify-content-between align-items-center flex-wrap">
                      <div class="media mb-2 mb-sm-0">
                          <img class="mr-4 img-fluid" src="{{ asset('images/teachers/juan.jpg') }}" alt="Teacher">
                          <div class="media-body">
                              <h4 class="mt-0">Juan Pascual.</h4>
                              Mtro. en matemáticas aplicadas.
                          </div>
                      </div>
