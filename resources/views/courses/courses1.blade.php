    ...
    <div class="container">
      <div class="row no-gutters">
        <div class="col-lg-4 text-center text-lg-left">
          <a class="text-color mr-3" href="tel:+443003030266"><strong>CALL</strong> +52 300 303 0266</a>
        ...
        <div class="col-lg-8 text-center text-lg-right">
          <ul class="list-inline">
            ...
            <li class="list-inline-item"><a class="text-uppercase text-color p-sm-2 py-2 px-0 d-inline-block" href="#signupModal" data-toggle="modal" data-target="#signupModal">Registrate</a></li>
          </ul>
        </div>
      </div>
    </div>
...
<!-- section -->
<section class="section overlay" data-background="{{ asset('images/courses/IMG-20231026-WA0001.jpg') }}">
    <div class="col-md-auto mb-4">
          <!-- success story -->
          <section class="section bg-cover" data-background="{{ asset('images/courses/IMG-20231026-WA0001.jpg') }}">
              <div class="container">
                  <div class="row">
                      <div class="col-lg-6 col-sm-4 position-relative success-video">
                          <a class="play-btn venobox" href="https://youtu.be/BT6JZIHg4A8?feature=shared" data-vbtype="video">
    ...
    <div class="container">
          ...
          <div class="row">
              <div class="col-12 mb-4">
                  ...
                  <p>En este fascinante curso desde cero, exploraremos juntos el emocionante mundo de la robótica. Comenzaremos con los conceptos más básicos, desde la selección de componentes hasta la programación de movimientos. A medida que avanzamos, te sumergirás en proyectos prácticos que te ayudarán a aplicar tus conocimientos y construir tu propio robot desde cero. Con ejercicios interactivos y guías detalladas, este curso es perfecto para principiantes que sueñan con crear sus propios robots.</p>
              </div>
              <div class="col-12 mb-4">
                      ...
                      <div class="row">
                          <div class="col-md-6">
                              <ul class="list-styled">
                                  <li>Conocimientos Básicos de Electrónica.</li>
              ...
              <div class="col-12 mb-4">
                  ...
                  <ul class="list-styled">
                      <li>Conceptos de Robótica: Comprenderán los principios básicos de la robótica, como la cinemática, la mecánica y la inteligencia artificial aplicada a robots.</li>
                      <li>Diseño y Construcción de Robots: Aprenderán a diseñar y construir un robot desde cero, incluyendo la elección de componentes, la fabricación de la estructura y la conexión de los circuitos.</li>
                      <li>Programación de Robots: Obtendrán las habilidades necesarias para programar el robot y controlarlo de manera autónoma o a través de un control remoto.</li>
                      <li>Resolución de Problemas: Desarrollarán habilidades para solucionar problemas relacionados con la robótica, lo que les permitirá abordar desafíos y proyectos más avanzados en el futuro.</li>
                  </ul>
              </div>
              <div class="col-12 mb-5">
                  <h3>Detalles del curso</h3>
                  <ul class="list-styled">
                      <li>Duración: El curso consta de 10 módulos, cada uno con una duración aproximada de 2 horas, lo que hace un total de 20 horas de contenido.</li>
                      <li>Modalidad: El curso se imparte en línea, lo que permite a los estudiantes aprender a su propio ritmo.</li>
                      <li>Materiales: Se proporcionarán materiales en línea, como tutoriales, videos y documentación técnica.</li>
                      <li>Proyecto Final: Al final del curso, los estudiantes tendrán la oportunidad de aplicar lo que han aprendido en un proyecto final, donde diseñarán, construirán y programarán su propio robot.</li>
                      <li>Certificación: Al completar con éxito el curso, los participantes recibirán un certificado de finalización que atestiguará sus habilidades en robótica.</li>
                  </ul>
              </div>
              <!-- teacher -->
              <div class="col-12">
                  ...
                  <div class="d-flex justify-content-between align-items-center flex-wrap">
                      <div class="media mb-2 mb-sm-0">
                          <img class="mr-4 img-fluid" src="{{ asset('images/teachers/davidportilla.jpg') }}" alt="Teacher">
                          <div class="media-body">
                              <h4 class="mt-0">David Portilla.</h4>
                              Ing. Computación.
                          </div>
                      </div>
                      <div class="social-link">
                          <h6 class="d-none d-sm-block">Redes Sociales</h6>
                          <ul class="list-inline">
